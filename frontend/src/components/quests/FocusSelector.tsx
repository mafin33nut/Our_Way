...
export function FocusSelector({ currentFocus, onSelectFocus, loading }: FocusSelectorProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 rounded-lg border-2 border-purple-500/50 p-6 shadow-xl backdrop-blur-sm ring-2 ring-violet-400/50 ring-offset-2 ring-offset-slate-900">
