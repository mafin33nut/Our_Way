        ...
        <div className="w-full max-w-[1600px]">
          <div className="relative rounded-2xl bg-slate-900/90 border border-slate-700/70 shadow-[0_20px_46px_-16px_rgba(15,23,42,0.95)] p-8 sm:p-10 min-h-[58vh]">
            ...
            <div className="flex justify-center mt-4">
              <h2 className="font-ow-brand text-slate-50 text-3xl sm:text-4xl">Our way</h2>
            </div>

            <div className="mt-16 flex items-center justify-center">
              <div className="grid grid-cols-1 gap-4 w-full max-w-[1800px]">
                <div className="group rounded-2xl p-[2px] bg-gradient-to-r from-teal-400/75 via-cyan-400/70 to-violet-500/75 transition-transform duration-300 hover:scale-[1.03] hover:translate-x-1">
                  <div className="rounded-2xl bg-slate-900/90 px-7 py-4 sm:px-9 sm:py-4">
                    <Button
                ...
                <div className="group rounded-2xl p-[2px] bg-gradient-to-r from-violet-500/75 via-fuchsia-500/70 to-teal-400/75 transition-transform duration-300 hover:scale-[1.03] hover:-translate-x-1">
                  <div className="rounded-2xl bg-slate-900/90 px-7 py-4 sm:px-9 sm:py-4">
                    <Button
