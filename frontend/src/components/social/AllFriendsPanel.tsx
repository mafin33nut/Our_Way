            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <p className={`text-sm truncate ${isLight ? 'text-slate-900' : 'text-purple-200'}`}>{friend.username}</p>
                  <p className={`text-xs ${isLight ? 'text-slate-600' : 'text-purple-200/40'}`}>Уровень {friend.level}</p>
                </div>
              </div>
