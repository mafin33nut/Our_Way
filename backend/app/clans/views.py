...
class ClanQuestViewSet(viewsets.ModelViewSet):
    ...
    def generate(self, request):
        ...
        tasks = [
            ...
            ('Нетворкинг-сессия', 'Собрать контакты и написать follow-up (90 мин).', 'legendary', 150),
            ('Крупный шаг в проекте', 'Реализовать и протестировать часть (60 мин).', 'legendary', 100),
            ('Сессия продуктивности', 'Pomodoro 50/10, закрыть 3 задачи (60 мин).', 'epic', 100),
            ...
            ('Обновить портфолио', 'Подготовить и задеплоить демо (60 мин).', 'epic', 100),
            ...
            ('Глубокое ревью', '3–5 PR с комментариями (90 мин).', 'legendary', 150),
            ('Конспект материала', 'Глава/статья с 15 идеями (60 мин).', 'epic', 100),
            ('Серия упражнений', '20–30 задач по теме (60 мин).', 'legendary', 100),
            ('Практический семинар', 'Теория + мини‑проект (60 мин).', 'epic', 100),
            ('Флеш‑карты', '30–50 терминов (60 мин).', 'epic', 100),
            ('Пилотная презентация', '10 мин выступление (60 мин).', 'epic', 100),
